...
def run_large_exp(envName = "riverSwim", timeHorizon=1000, nbReplicates=100):
    ...
    learners.append(psrl.PSRL(envOpt.observation_space.n, envOpt.action_space.n, delta=0.05 ))
...
def plotXpsArticle():
    tmax=10000000
    plot_results_from_dump('riverSwim6',tmax=tmax,tplot=tmax/10)
    plot_results_from_dump('4-room',tmax=tmax,tplot=tmax)
    plot_results_from_dump('2-room',tmax=tmax,tplot=tmax)
    plot_results_from_dump('random100',tmax=tmax,tplot=tmax)
    plot_results_from_dump('randomRich',tmax=tmax,tplot=tmax)
    plot_results_from_dump('riverSwim25',tmax=tmax,tplot=tmax)
